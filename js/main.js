...
(function($) {
    ...
    const sections = [
        { name: "DGII", count: 5 },
        { name: "DR-VII", count: 11},
		{ name: "DR-VIII", count: 7 },
		{ name: "Iglesia", count: 9 },
		{ name: "Honda", count: 6 },
        { name: "Imperial", count: 10 },
        { name: "NaveForum", count: 13 },
        { name: "Nesplas", count: 8 },
        { name: "PlazaEnsu", count: 12 },
        { name: "TorreLeonardoVI", count: 8 },
        { name: "TorreMelconXV", count: 3 },
        { name: "TorreMerlotInsignia", count: 4},
        { name: "TorreSavalIV", count: 4 },
        { name: "TorreStateraEmpíreo", count: 12 },
        { name: "TorreVertical", count: 5 },
        { name: "TorreW", count: 1},
    ];
		...
		html += `
                <div class="col-sm-4 col-xs-6 single-item padding-10 andamios">
                    <div class="portfolio-box">
                        <img class="img-w1" src="${section.name}/1.JPEG" data-src="${section.name}/1.JPEG" alt="Portfolio Image">
                        <a href="${section.name}/1.JPEG" class="overlay text-center ">
                            <div class="display-table">
                                <div class="table-cell padding-15">
                                    <h4 class="mb-10 fz-16 text-white display-inline-block bdrs-3 padding-25 ptb-15 bg-yellow">${section.name}</h4>
                                    <p class="no-margin fz-14">¡Tu acceso seguro y confiable a cada desafío en altura!</p>
                                </div>
                            </div>
                        </a>
                    </div>
        ...
        for (let i = 2; i <= section.count; i++) {
            html += `
                <div class="col-sm-4 col-xs-6 single-item padding-10 andamios noshow">
                    <div class="portfolio-box">
                        <img class="img-w1" data-src="${section.name}/${i}.JPEG" alt="Portfolio Image">
