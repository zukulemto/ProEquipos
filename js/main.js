...
(function($) {
    ...
    const sections = [
        ...
        { name: "TorreStateraEmpíreo", count: 14 },
		...
		html += `
                <div class="col-sm-4 col-xs-6 single-item padding-10 andamios">
                    <div class="portfolio-box">
                        <img loading="lazy" class="img-w1" src="${section.name}/1.JPEG" alt="Portfolio Image">
        ...
        for (let i = 2; i <= section.count; i++) {
            html += `
                <div class="col-sm-4 col-xs-6 single-item padding-10 andamios noshow">
                    <div class="portfolio-box">
                        <img loading="lazy" class="img-w1" src="${section.name}/${i}.JPEG" alt="Portfolio Image">
